...
Inside the package org.uberfire.client, modify the setup method like follows to define the "TaskPerspective" we just define before (instead of the "MainPerspective"):
